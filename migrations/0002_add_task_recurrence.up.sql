ALTER TABLE tasks ADD COLUMN recuerrenc_type VARCHAR(20) NOT NULL DEFAULT 'none';
...
COMMENT ON COLUMN tasks.recurrence_config IS 'JSON с параметрами периодичности (например, {"interval": 3} для daily, {"days": [5,15,25]} для specific_dates)';
